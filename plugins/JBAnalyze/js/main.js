            ...
            browser.addGlobalMenuItem( menuName, new dijitMenuItem({
                ...
                onClick: function() {
                    ...
                    new dButton({
                        ...
                        onClick: function() {
                            //alert('ding');
                            $.post( thisb.pre+"/util/democleanup",{dataset:browser.config.dataRoot}, function( data) {
...
*/
    ...
    getWorkflows(cb,servModule) {
        ...
        console.log('pre-getworkflows',this.browser)
        let xhr = $.get( pre+"/service/exec?cmd=get_workflows&module="+servModule, function( data ) {
